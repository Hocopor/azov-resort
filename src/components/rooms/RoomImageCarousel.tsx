      ...
      {hasMultiple && (
        <>
          <button
            ...
            className="absolute left-3 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/80 text-sea-900 shadow-md backdrop-blur-sm transition-all duration-300 hover:bg-white hover:scale-110 opacity-80 md:opacity-80 md:group-hover:opacity-100"
          >
          ...
          <button
            ...
            onClick={showNext}
            className="absolute right-3 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/80 text-sea-900 shadow-md backdrop-blur-sm transition-all duration-300 hover:bg-white hover:scale-110 opacity-80 md:opacity-80 md:group-hover:opacity-100"
          >
