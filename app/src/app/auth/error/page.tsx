...
const errorMessages: Record<string, string> = {
  OAuthAccountNotLinked: 'Этот email уже используется с другим способом входа. Попробуйте войти через email или другой сервис.',
  ...
  return (
    <div className="text-center">
      ...
      <div className="flex flex-col gap-3">
        <Link href="/auth/login" className="btn-primary justify-center">Попробовать снова</Link>
        <Link href="/" className="text-sm text-gray-400 hover:text-gray-600">На главную</Link>
      </div>
    </div>
  )
}
